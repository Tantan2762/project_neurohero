...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Neuro-Hero - Parenting Inklusif Kolaboratif</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport" />
    <meta content="Free HTML Templates" name="keywords" />
    <meta content="Free HTML Templates" name="description" />

    <!-- Favicon -->
    <link href="{{asset('vendor/assets/img/favicon.ico')}}" rel="icon" />
    ...
    <!-- Flaticon Font -->
    <link href="{{asset('vendor/assets/lib/flaticon/font/flaticon.css')}}" rel="stylesheet" />
  ...
  <body>
    ...
    <div class="container-fluid bg-light position-relative shadow">
      ...
      >
        ...
        >
        <img class="p-3" style="width: 5em;" src="{{asset('vendor/assets/img/logo.png')}}" alt="" />
        </a>
        <button
          type="button"
   ...
   @yield('content')
    ...
    <script src="{{asset('vendor/assets/mail/jqBootstrapValidation.min.js')}}"></script>
    <script src="{{asset('vendor/assets/mail/contact.js')}}"></script>
